...
/**
 * Testing ResponseProcessor methods
 * 
 * @version 1.0
 * @date    2010-04-06
 * @author  Barbara M. Rodeker
 */
public class ResponsesProcessorTest extends TestCase {

    public void testResponsesProcessor() {
	ResponsesProcessor processor = null;
	try {
